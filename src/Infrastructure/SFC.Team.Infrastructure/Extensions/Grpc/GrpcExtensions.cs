...
using SFC.Team.Infrastructure.Interceptors.Grpc.Client;
using SFC.Team.Infrastructure.Interceptors.Grpc.Server;
...
namespace SFC.Team.Infrastructure.Extensions.Grpc;

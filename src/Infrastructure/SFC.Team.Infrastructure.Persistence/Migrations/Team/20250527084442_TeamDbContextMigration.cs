        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8309), "Active" },
                    { 1, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8320), "Injured" },
                    { 2, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8326), "Retired" },
                    { 3, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8331), "Unavailable" },
                    { 4, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8335), "Removed" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8189), "Temporary" },
                    { 1, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8203), "Active" },
                    { 2, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8210), "Inactive" },
                    { 3, new DateTime(2025, 5, 27, 8, 44, 41, 895, DateTimeKind.Utc).AddTicks(8214), "Closed" }
                });
